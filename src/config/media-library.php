...
return [
     ...
     */
    'disk_name' => env('MEDIA_DISK', 'facial_photos'),
     ...
     */
    'conversions_disk_name' => env('MEDIA_CONVERSIONS_DISK', 'facial_photos'),
    ...
    'custom_path_generators' => [
        FacialPhotoRecord::class => FacialPhotoPathGenerator::class,
    ],
     ...
     */
    'temporary_directory_path' => storage_path('app/private/media-library/temp'),
