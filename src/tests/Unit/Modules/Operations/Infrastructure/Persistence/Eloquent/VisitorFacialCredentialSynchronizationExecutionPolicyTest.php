...
final class VisitorFacialCredentialSynchronizationExecutionPolicyTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_it_allows_an_authorized_user_in_the_selected_group_and_unit(): void
    {
        ...
        self::assertTrue(
            $policy->executeFacialCredentialSynchronization(
                $user,
                $visitor
            )
        );
    ...
    public function test_it_denies_a_user_without_the_specific_permission(): void
    {
        [
            ...
            $organization,
            $visitor,
        ] = $this->scopeFixture(' $policy->executeFacialCredentialSynchronization(
                $user,
                $visitor
            )
        );
