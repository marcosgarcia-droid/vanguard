...
use App\Modules\Identity\UI\Filament\Resources\EmployeeRecords\Actions\EmployeeFacialCredentialSynchronizationDeviceSelection;
...
final class EmployeeFacialCredentialSynchronizationDeviceSelectionTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_it_fails_closed_when_the_employee_has_no_scope(): void
    {
        ...
        self::assertSame(
            'O funcionário não possui grupo empresarial e unidade válidos.',
            EmployeeFacialCredentialSynchronizationDeviceSelection::unavailableReason(
                $employee
            )
        );
    }
