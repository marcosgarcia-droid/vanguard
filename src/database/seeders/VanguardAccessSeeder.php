...
class VanguardAccessSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $visitorPermissions = [
            ...
            'Delete:VisitorRecord',
            'DeleteAny:VisitorRecord',
            'Restore:VisitorRecord',
            'RestoreAny:VisitorRecord',
            'ForceDelete:VisitorRecord',
            'ForceDeleteAny:VisitorRecord',
        ];
        ...
        $visitPermissions = [
            ...
            'Update:VisitRecord',
            'Delete:VisitRecord',
            'DeleteAny:VisitRecord',
            'Restore:VisitRecord',
            'RestoreAny:VisitRecord',
            'ForceDelete:VisitRecord',
