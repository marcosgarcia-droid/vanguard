...
final class VisitorFacialCredentialSynchronizationCreationPresentation
{
    ...
    private static function blockedMessage(
        ...
        return match ($result->reason) {
            CreateFacialCredentialSynchronizationReason::VisitorNotFound => 'O visitante não foi localizado.',

            CreateFacialCredentialSynchronizationReason::VisitorInactive => 'Somente visitantes ativos podem possuir uma intenção de sincronização facial.',
            ...
            CreateFacialCredentialSynchronizationReason::ScopeMismatch => 'O leitor facial não pertence ao mesmo grupo empresarial e unidade do visitante.',

            CreateFacialCredentialSynchronizationReason::CurrentPhotoMissing => 'O visitante ainda não possui uma foto facial atual.',
