...
final class EmployeeWorkScheduleDayRecord extends Model
{
    use LogsVanguardActivity;

    protected $table = 'employee_work_schedule_days';
    ...
    {
        return $this->belongsTo(EmployeeWorkScheduleRecord::class, 'employee_work_schedule_id');
    }
}
